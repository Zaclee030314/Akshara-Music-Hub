...
export const effectiveStatus = (season, now) => {
...
// Students only.
export const seasonScores = async (start, end) => {
...
export const getActiveSeason = async (now) => {
...
export const getUserSeasonXp = async (userId, now) => {
