...
export const isValidSyllabus = (syllabus) => typeof syllabus === 'string' && SYLLABUSES.includes(syllabus);
/** Every grade string selectable under a given syllabus. */
export const gradesForSyllabus = (syllabus) => {
    switch (syllabus) {
...
export const isValidGradeForSyllabus = (syllabus, grade) => typeof grade === 'string' && gradesForSyllabus(syllabus).includes(grade);
