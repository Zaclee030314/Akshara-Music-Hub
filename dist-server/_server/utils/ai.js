...
export async function generateAIContent(prompt, modelName = PRIMARY_MODEL, responseMimeType) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            try {
                ...
                if (e.message.includes("Gemini API Error") || e.message.includes("Model not found"))
                    throw e;
