...
export const isMusicSyllabus = (syllabus) => syllabus === 'Western Music' ||
...
export const schoolAge = (birthday, now) => now.getUTCFullYear() - birthday.getUTCFullYear();
const clamp = (n, lo, hi) => Math.min(Math.max(n, lo), hi);
// 'Form 6 (STPM)' is the literal GradeLevel.FORM_6 string — never emit a bare 'Form 6'.
const FORM_6 = 'Form 6 (STPM)';
const formName = (n) => (n >= 6 ? FORM_6 : `Form ${n}`);
/**
 ...
 */
export const expectedGradeFor = (syllabus, birthday, now) => {
