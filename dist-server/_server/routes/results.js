...
router.post('/', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        const ageGrade = (!isMusicSyllabus(user.gradeSyllabus) && user.birthday)
        ...
        console.log(`[GATE] user=${userId} birthday=${user.birthday ? user.birthday.toISOString().slice(0, 10) : 'none'} ` +
