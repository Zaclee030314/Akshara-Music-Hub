...
export const getGradeSyllabus = (subject, grade) => GRADE_SYLLABUS[subject]?.[grade] ?? null;
/** Derive a "Topic N: …" list from a grade syllabus (for subjects with no hand-authored topic tree). */
export const syllabusToTopics = (entry) => {
    const items = [
