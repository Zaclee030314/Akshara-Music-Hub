// AUTO-GENERATED from api/_server/data/seed/*.json — do not edit by hand.
// Regenerate with the gen-reference-banks script after updating the seed files.
//
// Official Akshara Fine Arts question banks, bundled into the server so AI quest
// generation can use them as style/terminology reference WITHOUT a database.
// (The same content can also be seeded into QuestionBank via npm run seed:music,
// at which point the bank-first path serves them verbatim.)
